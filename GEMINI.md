...
>
> 1. Run `pwsh/1_Prepare_And_Convert.ps1`.
> 2. Run `pwsh/2_Split_Audio.ps1`.
> 3. Run `pwsh/3_Run_whisper.ps1`.
> 4. Run `pwsh/4_Merge_SRT.ps1`.
...
> 6. Run `pwsh/6_Fix_Error_Words.ps1`.
> 7. Run `pwsh/7_Extract_Text.ps1`.
